/* jshint indent: 2*/
/* global Timer, //jasmine, describe, it, beforeEach, expect, afterEach */'use strict';
...
describe('Timer', function() {
    ...
    describe('#getDuration', function() {
        ...
        xit('should return 0 if timer isn\'t started or paused', function() {
            //initial
        ...
        xit('should return actual value', function() {
            timer.start(10);
    ...
    describe('#start', function() {
        ...
        xit('should resume timer after pause', function() {
            timer.on('end', end);
            timer.start(5);
        ...
        xit('should restart timer if argument provided after pause', function() {
            timer.on('end', end);
            timer.start(5);
            ...
            expect(timer.getDuration()).toBe(9999);
